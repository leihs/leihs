class EditCategoryController
  ...
  delegateEvents: ->
    ...
    $(document).on "keyup change", "[ng-model='category.name']", @changeCurrentCategoryName
  ...
  changeCategoryLink: ->
    ...
    if target.is(":checked")
      for treeElement in sameCategories
        ...
        template = $.tmpl "app/views/categories/tree_element", {parent_id: target.val(), name: $("[ng-model='category.name']").val()}
...
window.App.EditCategoryController = EditCategoryController