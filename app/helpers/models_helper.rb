module ModelsHelper
  ...
  def display_with_children(categories, parent = nil)
    ...
    for category in categories
      ...
      output << "<span style='padding-left: 10px;'>" + link_to_remote(_("Add"), :update => 'basket', :url => {:controller => 'orders', :action => 'add_line', :model_group_id => category.id}) + "</span>" if category.type == "Template"
      output << "</span>"
