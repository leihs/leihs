module Backend::BackendHelper
  ...
  def table_with_search_and_pagination(options = {}, html_options = {}, &block)
    html = content_tag :div, :class => "table-overview boxes", :id => 'list_table' do
