...
#----------------------------------------------------------
# Loeschen einer Reservation / haengender Reservationen
  ...
  def destroy
    ...
    email = LeihsMailer.deliver_benachrichtigung( self ) if user != updater and self.status > STATUS_ZUSAMMENSTELLEN
    pakets.clear
    save
    super
  end
