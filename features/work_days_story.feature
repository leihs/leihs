...
Scenario: Default Workdays
	...
	When I try to order an item for 3.10.2100
	Then the order should not be approvable because it's a sunday
	
	When I try to order an item for 4.10.2100
	Then the order should be approvable
	
	When I try to order an item for 5.10.2100
	Then the order should be approvable
	
	When I try to order an item for 6.10.2100
	Then the order should be approvable
	
	When I try to order an item for 7.10.2100
	Then the order should be approvable
	
	When I try to order an item for 8.10.2100
	Then the order should be approvable
...
Scenario: With Holidays
	...
	Given holidays are from 1.7.2100 - 29.7.2100 because of Summer Holiday
		And 1.1.2100 is free because of New Year
	
	When I try to order an item for 1.1.2100
	Then the order should not be approvable (because of New Year)
	
	When I try to order an item for 4.1.2100
	Then the order should be approvable
	
	When I try to order an item for 1.7.2100
	Then the order should not be approvable (because of Summer Holiday)
	
	When I try to order an item for 29.7.2100
	Then the order should not be approvable (because of Summer Holiday)
	
	When I try to order an item for 20.7.2100
	Then the order should not be approvable (because of Summer Holiday)
	
	When I try to order an item for 30.7.2100
	Then the order should be approvable
