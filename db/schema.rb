...
ActiveRecord::Schema.define(:version => 20090421140116) do
  ...
  add_index "contract_lines", ["location_id"], :name => "index_contract_lines_on_location_id"
  ...
  add_index "locations", ["inventory_pool_id"], :name => "index_locations_on_inventory_pool_id"
