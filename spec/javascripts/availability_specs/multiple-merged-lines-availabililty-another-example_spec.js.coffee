describe "Merging multiple lines availability in total and for partitions", ->
  ...
  beforeEach ->
    ...
    @lines[0] = availability_for_inventory_pool:
      ...
      availability: 
        [["2012-02-27", 1, [{group_id: 0, in_quantity: 1}]],
         ["2012-03-28", 2, [{group_id: 0, in_quantity: 2}]],
         ["2012-06-01", 2, [{group_id: 0, in_quantity: 2}]],
         ["2012-06-30", 2, [{group_id: 0, in_quantity: 2}]]
        ]
    @lines[1] = availability_for_inventory_pool:
      ...
      availability: 
        [["2012-02-27", 1, [{group_id: 0, in_quantity: 1}]],
         ["2012-06-01", 1, [{group_id: 0, in_quantity: 1}]],
         ["2012-06-30", 1, [{group_id: 0, in_quantity: 1}]]
        ]
