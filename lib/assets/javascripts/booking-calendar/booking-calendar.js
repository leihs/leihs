...
function BookingCalendar() {
  ...
  this.setupJumptoDate = function() {
    $(".fc-goto-start").click(function(){
      BookingCalendar.gotoDate(moment($("#start_date").val(), BookingCalendar.local.dateFormat));
    });
    
    $(".fc-goto-end").click(function(){
      BookingCalendar.gotoDate(moment($("#end_date").val(), BookingCalendar.local.dateFormat));
    });
  }
